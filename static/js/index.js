...
function rpsGame(yourChoice) {
    ...
    rpsFrontEnd(yourChoice.id, botChoice, message); //not return string, it returns dictionary(object).
...
function showCard(card, activePlayer) {
    if(activePlayer['score'] <= 21) {
        ...
        cardImage.src = `./static/blackjack-images/${card}.png`;
...
function computeWinner() {
    ...
    if(YOU['score'] <= 21) {
        //condition: higher score than dealer or when dealer busts but you're score less then dealer.
